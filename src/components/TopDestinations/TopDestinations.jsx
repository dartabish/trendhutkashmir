      ...
      <div>
        <div className="max-w-7xl mx-auto">
          <div className="grid justify-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group overflow-hidden rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <div className="absolute inset-0 bg-[url('https://media.gettyimages.com/id/1239793097/photo/srinagar-jammu-and-kashmir-india-general-view-of-tulips-in-bloom-inside-tulip-garden-during.jpg?s=612x612&w=0&k=20&c=AvzZler8YMr3TWle530SKe2fBLPHKqSiuppBAp5M6qY=')] bg-cover bg-center group-hover:scale-110 transition-transform duration-300"></div>
              <div className="absolute inset-0 bg-black/50 group-hover:bg-black/40 transition-colors duration-300"></div>
              <div className="relative p-6 flex flex-col justify-end h-64">
                <h2 className="text-white text-2xl font-bold">Tulip Garden</h2>
              </div>
            </div>
